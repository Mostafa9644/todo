...
def loginuser(request):
    if request.method=='GET':
        ...
        if user is None:
            return render(request,'todo/loginuser.html',{'form':AuthenticationForm(),'error':'User name and password didnt match up'})    
        else:
            login(request,user)
            return redirect('currenttodos')
@login_required          
...
def createtodo(request):
    if request.method=='GET':
        return render(request,'todo/createtodo.html',{'form':TodoForms()})
    else:
        try:
            ...
            return render(request,'todo/createtodo.html',{'form':TodoForms(),'error':'Bad data pass in'})
